...
import nobinobi.obj.editable.ChallengeSceneEditable;
...
public class ChallengeSceneFrame extends JFrame implements WindowListener {
    ...
    private JPanel createListPanel() {
        ...
        btnSave.addActionListener(e -> {
            try {
                PrintWriter writer = new PrintWriter(new FileOutputStream("nobinobi/obj/saves/challengescene.csv"));
    ...
    private void loadScenes() {
        File file = new File("nobinobi/obj/saves/challengescene.csv");
